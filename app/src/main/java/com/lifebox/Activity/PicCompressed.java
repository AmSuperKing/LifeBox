...
public class PicCompressed extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pic_compressed);
        WebView webView = findViewById(R.id.pic_webview);
        ...
        webView.loadUrl("https://zh.recompressor.com/");
    }
